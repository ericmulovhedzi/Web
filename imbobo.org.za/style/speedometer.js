...
function drawTextMarkers(options) {
	...
	// Font styling
	options.ctx.font = 'bold 22px sans-serif';
	...
	for (iTick = 10; iTick < 180; iTick += 15) {
		...
		if (iTick <= 10) {
			options.ctx.fillText(_I, (options.center.X - gaugeOptions.radius - 14) + innerTickX,
					(gaugeOptions.center.Y - gaugeOptions.radius - 18) + innerTickY + 5);
		} else if (iTick < 50) {
			options.ctx.fillText(_I, (options.center.X - gaugeOptions.radius - 12) + innerTickX - 5,
					(gaugeOptions.center.Y - gaugeOptions.radius - 18) + innerTickY + 5);
		} else if (iTick < 90) {
			options.ctx.fillText(_I, (options.center.X - gaugeOptions.radius - 10) + innerTickX,
					(gaugeOptions.center.Y - gaugeOptions.radius - 20) + innerTickY);
		} else if (iTick === 90) {
			options.ctx.fillText(_I, (options.center.X - gaugeOptions.radius - 12) + innerTickX + 4,
					(gaugeOptions.center.Y - gaugeOptions.radius - 22) + innerTickY);
		} else if (iTick < 145) {
			options.ctx.fillText(_I, (options.center.X - gaugeOptions.radius - 12) + innerTickX + 10,
					(gaugeOptions.center.Y - gaugeOptions.radius - 22) + innerTickY);
		} else {
			options.ctx.fillText(_I, (options.center.X - gaugeOptions.radius - 12) + innerTickX + 15,
					(gaugeOptions.center.Y - gaugeOptions.radius - 20) + innerTickY + 5);
		}
